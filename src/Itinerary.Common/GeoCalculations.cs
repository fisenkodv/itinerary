...
namespace Itinerary.Common
{
  public static class GeoCalculations
  {
    ...
    {
      return Distance(lat1, lng1, lat2, lng2, GeoCodeCalcMeasurement.Miles);
    }

    private static double Distance(double lat1, double lng1, double lat2, double lng2, GeoCodeCalcMeasurement measurement)
    {
